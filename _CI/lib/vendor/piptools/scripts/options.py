...
from lib.vendor.piptools.locations import CACHE_DIR, DEFAULT_CONFIG_FILE_NAMES
from lib.vendor.piptools.utils import UNSAFE_PACKAGES, override_defaults_from_config_file
