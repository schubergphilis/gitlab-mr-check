...
from lib.vendor.attrs import evolve, field
from lib.vendor.rpds import HashTrieMap, HashTrieSet, List

try:
    from lib.vendor.typing_extensions import TypeVar
except ImportError:  # pragma: no cover
    from typing import TypeVar

from lib.vendor.referencing import exceptions
from lib.vendor.referencing._attrs import frozen
from lib.vendor.referencing.typing import URI, Anchor as AnchorType, D, Mapping, Retrieve
...
def _detect_or_error(contents: D) -> Specification[D]:
    ...
    from lib.vendor.referencing.jsonschema import specification_with
