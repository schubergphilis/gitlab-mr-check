...
from lib.vendor.referencing import Anchor, Registry, Resource, Specification, exceptions
from lib.vendor.referencing._attrs import frozen
from lib.vendor.referencing._core import (
    _UNSET,  # type: ignore[reportPrivateUsage]
    Resolved as _Resolved,
    Resolver as _Resolver,
    _Unset,  # type: ignore[reportPrivateUsage]
)
from lib.vendor.referencing.typing import URI, Anchor as AnchorType, Mapping
