...
from lib.vendor.referencing import Resource

if TYPE_CHECKING:
    from lib.vendor.referencing.typing import URI, D, Retrieve
...
def to_cached_resource(
    ...
    .. testcode::
        ...
        from lib.vendor.referencing.typing import URI
        import lib.vendor.referencing.jsonschemaretrieval
