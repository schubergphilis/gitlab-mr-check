...
if hasattr(typing, "LiteralString"):  # 3.11+
    ...
    def LiteralString(self, params):
        ...
        Example::
          ...
          from lib.vendor.typing_extensions import LiteralString
...
if hasattr(typing, "Never"):  # 3.11+
    ...
    def Never(self, params):
        ...
        called, or a function that never returns::
            ...
            from lib.vendor.typing_extensions import Never
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        Example:
            ...
            from lib.vendor.typing_extensions import dataclass_transform
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(cls, /):
        ...
        Examples::
            ...
            from lib.vendor.typing_extensions import NamedTuple, TypedDict
